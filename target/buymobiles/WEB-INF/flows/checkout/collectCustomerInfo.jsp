...
<div class="container-wrapper" style="margin-top:50px; margin-bottom:50px;">
    <div class="container" style="background-color:#d7edf4">
        ...
        <div class="form-group">
            ...
            <form:input path="cart.customer.custname" id="name" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="email">Email</label>
            <form:input path="cart.customer.custemailid" id="email" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="phone">Phone</label>
            <form:input path="cart.customer.custmobileno" id="phone" class="form-Control" />
        </div>
